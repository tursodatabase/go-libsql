...
func NewEmbeddedReplicaConnector(dbPath, primaryUrl string, authToken string) (*Connector, error) {
	return openConnector(dbPath, primaryUrl, authToken, 0)
}

func NewEmbeddedReplicaConnectorWithAutoSync(dbPath, primaryUrl string, authToken string, syncInterval time.Duration) (*Connector, error) {
...
func openConnector(dbPath, primaryUrl string, authToken string, syncInterval time.Duration) (*Connector, error) {
...
func libsqlOpenWithSync(dbPath, primaryUrl string, authToken string) (C.libsql_database_t, error) {
